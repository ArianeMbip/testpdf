namespace ApiTestMongo.Databases;

using ApiTestMongo.Domain;
using ApiTestMongo.Databases.EntityConfigurations;
...
public sealed class TestMongoDbContext : DbContext
{
    ...
    public TestMongoDbContext(
        DbContextOptions<TestMongoDbContext> options, ICurrentUserService currentUserService, IMediator mediator, IDateTimeProvider dateTimeProvider) : base(options)
    {
